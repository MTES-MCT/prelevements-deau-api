...
export const EXPLOITATIONS_MODALITES_DEFINITION = {
  schema: {
    id_exploitation: {parse: parsePositiveInteger},
    id_modalite: {parse: parsePositiveInteger}
  },
  requiredFields: ['id_exploitation', 'id_modalite']
}
...
export const MODALITES_DEFINITION = {
  schema: {
    ...
    freq_chlorures: {parse: value => parseNomenclature(value, frequences)},
    freq_nitrates: {parse: value => parseNomenclature(value, frequences)},
    freq_sulfates: {parse: value => parseNomenclature(value, frequences)},
    freq_turbidite: {parse: value => parseNomenclature(value, frequences)},
    remarque: {parse: parseString}
  },
