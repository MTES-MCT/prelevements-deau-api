import {typesMilieu, statutsExploitation, parametres, unites, contraintes, natures, precisionsGeom, parametreFrequences} from './nomenclature.js'
...
export const REGLES_DEFINITION = {
  schema: {
    ...
    frequence: {
      parse(value, row) {
        // Si le paramètre est 1, 2 ou 3 (anciens volumes j/m/a), utiliser le mapping automatique
        if (parametreFrequences[row.parametre]) {
          return parametreFrequences[row.parametre]
        }
