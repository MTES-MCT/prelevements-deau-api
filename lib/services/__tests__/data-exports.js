...
test('les périodes compteur exportées suivent les dates et heures Paris sans arrondir les instants', t => {
  const row = {metricTypeCode: 'volume', calculationStrategy: 'METER', frequency: 'irregular',
    periodStart: new Date('2025-12-31T23:00:00.123Z'), periodEnd: new Date('2026-01-01T23:00:00Z')}
  t.like(rowToExportObject(row), {
    dateDebutPeriode: '2026-01-01', heureDebutPeriode: '00:00:00.123', dateHeureDebutPeriode: '2026-01-01 00:00:00.123',
    dateFinPeriode: '2026-01-02', heureFinPeriode: '00:00:00', dateHeureFinPeriode: '2026-01-02 00:00:00'
  })
  t.like(rowToExportObject({...row, calculationStrategy: 'GENERIC'}), {
    dateDebutPeriode: '2025-12-31', heureDebutPeriode: '23:00:00', dateFinPeriode: '2026-01-01'
  })
  t.like(rowToExportObject({...row, periodStart: null, periodEnd: null}), {dateHeureDebutPeriode: '', dateHeureFinPeriode: ''})
})

test('les exports compteur respectent les journées Paris de 23 et 25 heures', t => {
  for (const [start, end, day, followingDay] of [
    ['2026-03-28T23:00:00Z', '2026-03-29T22:00:00Z', '2026-03-29', '2026-03-30'],
    ['2026-10-24T22:00:00Z', '2026-10-25T23:00:00Z', '2026-10-25', '2026-10-26']
  ]) {
    t.like(rowToExportObject({metricTypeCode: 'volume', calculationStrategy: 'METER', frequency: 'irregular',
      periodStart: start, periodEnd: end}), {
      dateHeureDebutPeriode: `${day} 00:00:00`, dateHeureFinPeriode: `${followingDay} 00:00:00`
    })
  }
})
