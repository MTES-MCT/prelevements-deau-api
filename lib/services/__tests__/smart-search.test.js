...
test('parseSmartSearch normalise les ligatures françaises', t => {
  t.deepEqual(parseSmartSearch('Cœur et ex æquo'), {
    ...
    terms: [
      {value: 'coeur', compact: 'coeur', fuzzyThreshold: 0.6},
      {value: 'et', compact: 'et', fuzzyThreshold: null},
      {value: 'ex', compact: 'ex', fuzzyThreshold: null},
      {value: 'aequo', compact: 'aequo', fuzzyThreshold: 0.6}
    ]
  })
})
