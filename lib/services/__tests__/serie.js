...
test('deleteSeriesByAttachmentWithIntegrations: deletes series, values and integrations', async t => {
...
test('deleteSeriesByAttachmentWithIntegrations: handles attachment without data', async t => {
  const attachmentId = new ObjectId()
