...
test('les routes campagnes imposent une session humaine et interdisent toute écriture en impersonation', t => {
  ...
  for (const handler of ['createCollectionCampaignHandler', 'updateCollectionCampaignHandler', 'saveCollectionResponseDraftHandler', 'submitCollectionResponseHandler', 'approveCollectionMeterHandler']) {
