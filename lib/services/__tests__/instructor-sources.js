...
test('les sources campagne restent lisibles mais sans boutons d’instruction ni de rapprochement génériques', t => {
  const chunk = {calculationStrategy: 'CAMPAIGN', pointPrelevementId: 'point', parsingInfo: {pointAssociationOrigin: 'MANUAL'}}
