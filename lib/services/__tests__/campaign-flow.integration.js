...
integration('éditer un remplacement conserve la chaîne et les relevés, accepte le snapshot en attente et refuse les déplacements ambigus', async t => {
  ...
  const secondEvent = {...event, at: '2026-05-01', previousCompteurId: firstId, previousIndex: '100', nextMeter: {serialNumber: 'Second compteur'}}
  ...
  const editedEvent = {...event, at: '2026-03-01', nextMeter: {serialNumber: 'Premier compteur corrigé'}, previousIndex: '220', reason: 'Motif précisé',
