...
export async function withSandreSyncLock(callback, {clientFactory, logger = console} = {}) {
  const client = clientFactory
    ? await clientFactory()
    : new Client(getPostgresConnectionOptions(process.env.DATABASE_URL, {keepAlive: true}))
  let lockError = null
