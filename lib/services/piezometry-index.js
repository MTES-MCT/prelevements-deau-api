...
export function aggregatePiezometryMonthlyValues(rows) {
...
export function buildPiezometryIpsFromMonthlyValues(monthlyValues, {
  start,
  end,
  now = new Date(),
...
export function buildPiezometryIps(rows, options) {
  return buildPiezometryIpsFromMonthlyValues(
