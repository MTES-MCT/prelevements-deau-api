...
async function createChunksFromData(data, sourceId, declarantUserId, _autoValidationEnabled, logger) {
  ...
  for (const chunk of data.series) {
    ...
    if (accessibleExploitationMatch) {
      usageExploitation = accessibleExploitationMatch.exploitation
