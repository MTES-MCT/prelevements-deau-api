...
test('normalizeSeries - converts units to reference', t => {
  const series = [{
    ...
    frequency: '1 hour',
    data: [
      {date: '2025-01-01', value: 36}, // 36 m³/h = 10 L/s
      {date: '2025-01-02', value: 72} // 72 m³/h = 20 L/s
    ]
  }]
  ...
  t.is(normalized[0].unit, 'L/s')
  t.is(normalized[0].data[0].value, 10)
  t.is(normalized[0].data[0].originalValue, 36)
  t.is(normalized[0].data[0].originalUnit, 'm³/h')
  t.is(normalized[0].data[1].value, 20)
})
  ...
  const series = [
    {
      ...
      frequency: '1 hour',
      data: [
        {date: '2025-01-01', time: '10:00', value: 36}, // 36 m³/h = 10 L/s
        {date: '2025-01-01', time: '11:00', value: 54} // 54 m³/h = 15 L/s
      ]
    },
    {
      pointPrelevement: 123,
      ...
      frequency: '1 hour',
      data: [
        {date: '2025-01-01', time: '10:00', value: 18}, // 18 m³/h = 5 L/s
        {date: '2025-01-01', time: '11:00', value: 28.8} // 28.8 m³/h = 8 L/s
      ]
    }
  ]
  ...
  const series = [
    {
      ...
      unit: 'm³/h',
      frequency: '1 hour',
      data: [{date: '2025-01-01', time: '10:00', value: 7.2}] // 7.2 m³/h = 2 L/s
    },
    {
      pointPrelevement: 123,
      parameter: 'débit réservé',
      unit: 'm³/h',
      frequency: '1 hour',
      data: [{date: '2025-01-01', time: '10:00', value: 10.8}] // 10.8 m³/h = 3 L/s
    }
  ]
...
test('normalizeSeries - aggregates only matching timestamps', t => {
  ...
  t.is(normalized.length, 1)
  // Seul le timestamp 10:00 a les deux sources, donc 11:00 est rejeté
  t.is(normalized[0].data.length, 1)
  t.is(normalized[0].data[0].date, '2025-01-01')
  t.is(normalized[0].data[0].time, '10:00')
  t.is(normalized[0].data[0].value, 15) // 10 + 5
...
test('normalizeSeries - preserves source information in aggregated data', t => {
  const series = [
    {
      ...
      unit: 'm³/h',
      frequency: '1 hour',
      data: [{date: '2025-01-01', time: '10:00', value: 36}] // 36 m³/h = 10 L/s
    },
    {
      pointPrelevement: 123,
      parameter: 'débit prélevé',
      unit: 'm³/h',
      frequency: '1 hour',
      data: [{date: '2025-01-01', time: '10:00', value: 18}] // 18 m³/h = 5 L/s
    }
  ]
  ...
  t.is(normalized.length, 1)
  t.is(normalized[0].data[0].value, 15) // 10 + 5 L/s
  t.is(normalized[0].data[0].sources.length, 2)
  t.is(normalized[0].data[0].sources[0].originalValue, 36)
  t.is(normalized[0].data[0].sources[0].originalUnit, 'm³/h')
  t.is(normalized[0].data[0].sources[1].originalValue, 18)
  t.is(normalized[0].data[0].sources[1].originalUnit, 'm³/h')
})

test('normalizeSeries - filters invalid values and aggregates remaining', t => {
  const series = [
    {
      pointPrelevement: 123,
      parameter: 'débit prélevé',
      ...
      frequency: '1 hour',
      data: [
        {date: '2025-01-01', time: '10:00', value: -10}, // Invalide (négatif)
        {date: '2025-01-01', time: '11:00', value: 15}, // Valide
        {date: '2025-01-01', time: '12:00', value: 20} // Valide
      ]
    },
    {
      pointPrelevement: 123,
      ...
      frequency: '1 hour',
      data: [
        {date: '2025-01-01', time: '10:00', value: 5}, // Valide
        {date: '2025-01-01', time: '11:00', value: 8}, // Valide
        {date: '2025-01-01', time: '12:00', value: -5} // Invalide (négatif)
      ]
    }
  ]
  ...
  t.is(normalized[0].aggregated, true)
  t.is(normalized[0].sourceCount, 2)
  // Seul le point 11:00 a les deux sources valides
  t.is(normalized[0].data.length, 1)

  // 11:00 - les deux séries valides
  t.is(normalized[0].data[0].date, '2025-01-01')
  t.is(normalized[0].data[0].time, '11:00')
  t.is(normalized[0].data[0].value, 23) // 15 + 8
  t.is(normalized[0].data[0].sources.length, 2)
})

test('normalizeSeries - rejects series with all invalid values', t => {
  const series = [
    {
      pointPrelevement: 123,
      parameter: 'débit prélevé',
      ...
      data: [
        ...
        {date: '2025-01-01', time: '12:00', value: -20}
      ]
    },
    {
      pointPrelevement: 123,
      ...
      data: [
        ...
        {date: '2025-01-01', time: '12:00', value: 10}
      ]
    }
  ]
  ...
  // La série avec toutes valeurs invalides est rejetée
  t.is(normalized.length, 1)
  t.is(normalized[0].aggregated, undefined) // Pas d'agrégation car une seule série conservée
  t.is(normalized[0].data.length, 3)
  t.is(normalized[0].data[0].value, 5)
  t.is(normalized[0].data[1].value, 8)
  t.is(normalized[0].data[2].value, 10)
})

test('normalizeSeries - rejects aggregation points with incomplete sources', t => {
  // Cas réaliste : deux captages d'une même installation
  // Le captage 1 a un problème de capteur qui produit des valeurs négatives
  const series = [
    {
      pointPrelevement: 123,
      parameter: 'débit prélevé',
      ...
      data: [
        {date: '2025-08-01', time: '00:00', value: -10}, // Capteur défaillant
        {date: '2025-08-01', time: '00:15', value: -10}, // Capteur défaillant
        {date: '2025-08-01', time: '00:30', value: 50}, // Capteur OK
        {date: '2025-08-01', time: '00:45', value: 55} // Capteur OK
      ]
    },
    {
      pointPrelevement: 123,
      ...
      frequency: '15 minutes',
      data: [
        {date: '2025-08-01', time: '00:00', value: 60},
        {date: '2025-08-01', time: '00:15', value: 62},
        {date: '2025-08-01', time: '00:30', value: 65},
        {date: '2025-08-01', time: '00:45', value: 67}
      ]
    }
  ]
  ...
  // Seuls les 2 derniers points sont conservés (00:30 et 00:45)
  // car les 2 premiers ont une source invalide
  t.is(normalized[0].data.length, 2)

  t.is(normalized[0].data[0].time, '00:30')
  t.is(normalized[0].data[0].value, 115) // 50 + 65
  t.is(normalized[0].data[0].sources.length, 2)

  t.is(normalized[0].data[1].time, '00:45')
  t.is(normalized[0].data[1].value, 122) // 55 + 67
  t.is(normalized[0].data[1].sources.length, 2)
})
