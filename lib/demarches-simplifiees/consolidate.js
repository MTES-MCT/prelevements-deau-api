...
import {chain, omit} from 'lodash-es'
...
import {insertSaisieJournaliere, hasSaisieJournaliere} from '../models/saisie-journaliere.js'
...
export async function consolidateDossier(demarcheNumber, dossierNumber) {
  ...
  for (const attachment of attachments) {
    ...
    for (const p of points) {
      ...
      for (const dailyValue of p.dailyValues) {
        const existingValue = await hasSaisieJournaliere(
