...
export default async function validateMultiParamFile(buffer, {startDate, endDate} = {}) {
  ...
  try {
    ...
    for (const sheetName of dataSheets) {
      ...
      const sheetContext = {...context, sheet, sheetName}
