...
test('readSheet avec un fichier Excel valide (xlsx) doit réussir', async t => {
...
test('readSheet avec un fichier Excel valide (xls) doit réussir', async t => {
...
test('readSheet avec un fichier ODS valide doit réussir', async t => {
...
test('readSheet avec un fichier non autorisé doit échouer', async t => {
...
test('readSheet avec un buffer vide doit échouer', async t => {
