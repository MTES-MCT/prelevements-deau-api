...
async function ensureZoneRight(user, zoneId, permission) {
  ...
  if (!await hasZonePermission(user, permission, [zoneId])) {
...
export async function getZoneDeclarationSettingsHandler(req, res) {
  ...
  await ensureZoneRight(req.user, zoneId, 'zone.declaration.settings.read')
...
export async function updateZoneDeclarationSettingsHandler(req, res) {
  ...
  await ensureZoneRight(req.user, zoneId, 'zone.declaration.settings.update')
...
export async function createZoneDeclarationOverrideHandler(req, res) {
  ...
  await ensureZoneRight(req.user, zoneId, 'zone.declaration.override.create')
...
export async function updateZoneDeclarationOverrideHandler(req, res) {
  ...
  await ensureZoneRight(req.user, zoneId, 'zone.declaration.override.update')
...
export async function deleteZoneDeclarationOverrideHandler(req, res) {
  ...
  await ensureZoneRight(req.user, zoneId, 'zone.declaration.override.delete')
