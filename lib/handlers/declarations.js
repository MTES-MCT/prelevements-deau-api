...
import {getReadableTelemetrySourceWhere, getVisibleTelemetryChunksWhere, scopeMeterSource} from '../services/telemetry-source-access.js'
...
function decorateTelemetrySourcesForDeclarant(sources, declarantUserIds) {
  return sources.map(scopeMeterSource).map(source => ({
    ...source,
