...
export async function reconcileDeclarationChunkHandler(req, res, next) {
  try {
    ...
    if (chunk.calculationStrategy === 'CAMPAIGN') {
      throw createHttpError(409, 'Cette série est gérée par une campagne. Utilisez la correction de la réponse de campagne.')
    }
