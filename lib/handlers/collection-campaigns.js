...
export async function exportCollectionResultsHandler(req, res) {
  ...
  const header = ['Préleveur', 'SIRET', 'Email', 'Point de prélèvement', 'Code comptage', 'Section', 'Numéro de compteur', 'Période', 'Usage', 'Index début (m³)', 'Index fin (m³)', 'Débit demandé (m³/h)', 'Volume demandé (m³)', 'Surface (ha)', 'Assolements', 'Publication des volumes', 'Dernier envoi', 'Commentaire', 'Volume prélevé publié (m³)']
