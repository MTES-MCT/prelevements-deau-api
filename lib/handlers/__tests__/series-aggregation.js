...
// Tests pour la validation (pointIds OR declarantId, ou les deux)
test('validateQueryParams - rejette si ni pointIds ni declarantId fourni', t => {
  const error = t.throws(() => {
    validateQueryParams({
...
test('validateQueryParams - accepte declarantId seul', t => {
  const result = validateQueryParams({
    preleveurId: 5,
    parameter: 'volume prélevé',
    aggregationFrequency: '1 day'
...
test('validateQueryParams - accepte declarantId ET pointIds ensemble', t => {
  const result = validateQueryParams({
    preleveurId: 5,
    pointIds: '1,2,3',
    parameter: 'volume prélevé',
...
test('validateQueryParams - declarantId doit être un nombre ou ObjectId', t => {
  const error = t.throws(() => {
    validateQueryParams({
      preleveurId: 'abc',
      parameter: 'volume prélevé',
...
test('validateQueryParams - accepte declarantId numérique', t => {
  const result = validateQueryParams({
    preleveurId: 42,
    parameter: 'volume prélevé',
    operator: 'sum'
...
test('validateQueryParams - accepte declarantId comme string numérique', t => {
  const result = validateQueryParams({
    preleveurId: '42',
    parameter: 'volume prélevé',
    operator: 'sum'
...
test('validateQueryParams - accepte declarantId comme ObjectId', t => {
  const result = validateQueryParams({
...
test('validateQueryParams - rejette declarantId ObjectId invalide (trop court)', t => {
  const error = t.throws(() => {
    validateQueryParams({
...
test('validateQueryParams - rejette declarantId ObjectId invalide (caractères invalides)', t => {
  const error = t.throws(() => {
    validateQueryParams({
...
test('validateQueryParams - rejette declarantId négatif', t => {
  const error = t.throws(() => {
    validateQueryParams({
      preleveurId: -5,
      parameter: 'volume prélevé',
...
test('validateQueryParams - rejette declarantId zéro', t => {
  const error = t.throws(() => {
    validateQueryParams({
      preleveurId: 0,
      parameter: 'volume prélevé',
...
test('validateQueryParams - accepte pointIds et declarantId ensemble (mode 3)', t => {
  const result = validateQueryParams({
    pointIds: '1,2,3',
    preleveurId: 42,
    parameter: 'volume prélevé',
...
test('validateQueryParams - accepte pointIds ObjectIds et declarantId ObjectId ensemble', t => {
  const result = validateQueryParams({
    pointIds: '507f1f77bcf86cd799439011,507f191e810c19729de860ea',
...
test('validateQueryParams - accepte mix pointIds numériques/ObjectIds avec declarantId numérique', t => {
  const result = validateQueryParams({
...
test('validateQueryParams - rejette si ni pointIds ni declarantId', t => {
  const error = t.throws(() => {
    validateQueryParams({
      parameter: 'volume prélevé',
      operator: 'sum'
