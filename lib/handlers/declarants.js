...
import {renderDeclarationReminderEmail, renderMagicLinkEmail} from '../util/email-templates.js'
...
export async function sendDeclarationReminderHandler(req, res) {
  ...
  await sendEmail(declarant.user.email, 'Partageons l\'Eau - Relance de déclaration', html)
