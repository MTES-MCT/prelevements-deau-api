...
import {getVisibleTelemetryChunksWhere, scopeMeterSource} from '../services/telemetry-source-access.js'
import {
...
function serializeChunk(chunk) {
  ...
  return {
    ...
    metadata: pickProperties(chunk.metadata, chunk.calculationStrategy === 'METER'
      ? ['calculationStrategy', 'totalWaterVolume', 'totalWaterVolumeWithdrawn', 'totalWaterVolumeDischarged']
      : ['readingDate']),
    ...(pointPrelevement
      ? {
        pointPrelevement: {
