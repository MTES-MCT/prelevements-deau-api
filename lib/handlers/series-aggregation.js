...
const SUPER_DAILY_FREQUENCIES = ['1 month', '1 year']
 ...
 */
async function fetchSeriesForAggregation({territoire, pointObjectIds, parameter, startDate, endDate}) {
...
export async function getAggregatedSeriesHandler(req, res) {
  ...
  const {pointIds: pointIdsStr, preleveurId, parameter, startDate: startDateStr, endDate: endDateStr, aggregationFrequency} = validated
