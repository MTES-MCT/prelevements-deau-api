...
export const JOBS = [
  ...
  {name: 'campaign-delivery', cron: '* * * * *', tz: 'Europe/Paris'},
  {name: 'campaign-reminders', cron: '0 * * * *', tz: 'Europe/Paris'},
  ...
  {name: 'sync-sandre-alert-zones', cron: '30 4 * * *', tz: 'Europe/Paris'},
  {name: 'purge-audit-events', cron: '15 3 * * *', tz: 'Europe/Paris'}
]
