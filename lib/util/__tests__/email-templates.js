...
test('renderDeclarationReminderEmail / utilise l’email quand le nom est absent', async t => {
  const html = await renderDeclarationReminderEmail(userWithoutName, 'https://app.example.test')
