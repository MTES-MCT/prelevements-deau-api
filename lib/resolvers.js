...
export async function handlePoint(req, res, next) {
  let pointId = parseObjectId(req.params.pointId)
...
export async function handlePreleveur(req, res, next) {
  let preleveurId = parseObjectId(req.params.preleveurId)
...
export async function handleExploitation(req, res, next) {
  let exploitationId = parseObjectId(req.params.exploitationId)
