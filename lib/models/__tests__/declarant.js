...
test('searchCollecteurPreleveurs charge un résumé léger puis hydrate seulement la page legacy', async t => {
      ...
      async findMany(arguments_) {
        ...
        return [
          link,
          {
            ...
            exploitation: {
              ...link.exploitation,
              id: '8c67a193-1c5c-4c9f-8ed3-6e4e6040ed38'
            }
          }
        ]
      }
  ...
  t.true(queries[0].select.exploitation.select.pointPrelevementId)
  ...
  t.is(compactResult.items[0].searchSummary.pointCount, 1)
