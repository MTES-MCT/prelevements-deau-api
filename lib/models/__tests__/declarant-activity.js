...
test('les acteurs capturés avant mutation couvrent déclaration et chunks', t => {
  t.deepEqual(getSourceActivityDeclarantUserIds({
    declaration: {
...
test('la requête d’activité retient les sources terminées et les chunks non rejetés', t => {
  ...
  t.regex(refreshQuery.sql, /THEN declaration\."createdAt"/)
