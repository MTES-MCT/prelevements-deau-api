...
export async function getStats() {
  ...
  return {
    nbActivExploitations: activExploitations.length,
    nbActivBeneficiaires: uniq(activBeneficiaires).length,
    nbActivPointsSurface: uniq(activPointsSurface).length,
    nbActivPointsSouterrain: uniq(activPointsSouterrain).length
  }
}
