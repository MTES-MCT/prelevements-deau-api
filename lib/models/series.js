...
export function buildPointPreleveurQuery({territoire, pointIds, preleveurId, parameter, from, to, onlyIntegratedDays}) {
...
export async function listSeries({
  ...
  const baseQuery = buildPointPreleveurQuery({territoire, pointIds, preleveurId, parameter, from, to, onlyIntegratedDays})
