...
import {getPreleveurExploitations, pointHasActiveExploitation, getExploitationsFromPointId} from './exploitation.js'
...
export async function getPointsFromPreleveur(preleveurId, includeDeleted = false) {
  ...
  return getPointsPrelevementByIds(pointIds, includeDeleted)
}
