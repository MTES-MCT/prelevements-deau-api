...
async function createRoutes() {
  ...
  app.get('/referentiels/bss/:idBss', w(ensureIsAdmin), w(async (req, res) => {
  ...
  app.get('/referentiels/bnpe/:idBnpe', w(ensureIsAdmin), w(async (req, res) => {
  ...
  app.get('/referentiels/me-continentales-bv/:idMeContinentalesBv', w(ensureIsAdmin), w(async (req, res) => {
  ...
  app.get('/referentiels/bv-bdcarthage/:idBvBdcarthage', w(ensureIsAdmin), w(async (req, res) => {
  ...
  app.get('/referentiels/meso/:idMeso', w(ensureIsAdmin), w(async (req, res) => {
    const meso = await getMeso(req.params.idMeso)

    res.send(meso)
  }))

  app.get('/referentiels/libelles', w(async (req, res) => {
    const libelles = await getLibellesCommune()

    res.send(libelles)
  }))

  app.get('/referentiels/libelles/:idCommune', w(ensureIsAdmin), w(async (req, res) => {
    const libelle = await getLibelleCommune(req.params.idCommune)
