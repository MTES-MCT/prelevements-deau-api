...
async function createRoutes() {
  ...
  app.route('/declarants')
    ...
    .post(ensureRole('INSTRUCTOR', 'ADMIN'), createPreleveurHandler)
  ...
  app.route('/declarants/:declarantId/declaration-types')
    ...
    .post(ensureRole('INSTRUCTOR', 'ADMIN'), authorizeDeclarant('read'), addDeclarantDeclarationTypeHandler)

  app.route('/declarants/:declarantId/declaration-types/:linkId')
    .put(ensureRole('INSTRUCTOR', 'ADMIN'), authorizeDeclarant('read'), updateDeclarantDeclarationTypeHandler)
    .delete(ensureRole('INSTRUCTOR', 'ADMIN'), authorizeDeclarant('read'), removeDeclarantDeclarationTypeHandler)
