...
async function createRoutes() {
  ...
  app.get('/auth/verify/:token', verifyAuth) // Legacy
  ...
  app.route('/points-prelevement')
    .get(ensureRole('reader'), listPointsPrelevement)
  ...
  app.get('/exploitations/:exploitationId/regles', authorize('exploitation', 'reader'), getExploitationRegles)
  ...
  app.get('/preleveurs/:preleveurId/exploitations-via-points', authorize('preleveur', 'reader'), getPreleveurExploitationsViaPointsHandler)
  ...
  app.get('/aggregated-series', ensureRole('reader'), getAggregatedSeriesHandler)

  // Options disponibles pour l'agrégation de séries (paramètres et plages de dates)
  app.get('/aggregated-series/options', ensureRole('reader'), getAggregatedSeriesOptionsHandler)
