...
async function createRoutes() {
  ...
  app.get('/exploitations/:id/series', w(async (req, res) => {
    const series = await getSeriesFromExploitationId(req.params.id)
  ...
  app.get('/series/:id/resultats', w(async (req, res) => {
    const resultats = await getResultatsFromSerieId(req.params.id)
