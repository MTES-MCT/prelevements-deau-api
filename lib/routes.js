...
async function createRoutes() {
  ...
  app.get('/exploitations/:exploitationId/documents', w(checkPermissionOnExploitation), w(async (req, res) => {
  ...
  app.route('/preleveurs/:preleveurId/regles')
    ...
    .post(w(checkPermissionOnPreleveur), w(async (req, res) => {
      const regle = await createRegle(req.body, req.preleveur._id, req.territoire.code)
      const decoratedRegle = await decorateRegle(regle)
  ...
  app.route('/preleveurs/:preleveurId/documents')
    ...
    .post(w(checkPermissionOnPreleveur), upload.single('document'), w(async (req, res) => {
      const document = await createDocument({
        ...
        codeTerritoire: req.territoire.code
      })
