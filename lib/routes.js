...
async function createRoutes() {
  ...
  app.use(w(async (req, res, next) => {
    ...
    req.isAdmin = true
    req.territoire = territoire.territoire
    req.demarcheNumber = territoire.demarcheNumber
  ...
  app.param('pointId', w(async (req, res, next) => {
    ...
    req.point = await getPointPrelevement(pointId, req.territoire)
