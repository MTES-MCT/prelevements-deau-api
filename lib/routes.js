...
import {
  listCampaignsHandler, listCampaignRequestsHandler, createCampaignHandler, getCampaignHandler, updateCampaignHandler, updateCampaignManagersHandler,
  openCampaignHandler, closeCampaignHandler, getCampaignContextHandler, getCampaignOptionsHandler,
  listCampaignResponsesHandler, saveCampaignResponseHandler, submitCampaignResponseHandler,
  reopenCampaignResponseHandler, manageCampaignMeterHandler, getCampaignResponseHistoryHandler
} from './handlers/campaigns.js'
import {getCampaignResponseSummaryHandler, listCampaignResponseOverviewHandler, getCampaignResponseResultsHandler} from './handlers/campaign-followup.js'
import {
  createCampaignExportHandler, listCampaignExportsHandler, getCampaignExportHandler,
  listCampaignNotificationsHandler, remindCampaignHandler
} from './handlers/campaign-delivery.js'
import {
...
export function createRoutes({
  ...
  app.get('/campaigns', ensureAuthenticated, listCampaignsHandler)
  app.post('/campaigns', ensureAuthenticated, createCampaignHandler)
  app.get('/campaigns/options', ensureAuthenticated, getCampaignOptionsHandler)
  app.get('/campaigns/requests', ensureAuthenticated, listCampaignRequestsHandler)
  app.get('/campaigns/:campaignId', ensureAuthenticated, getCampaignHandler)
  app.patch('/campaigns/:campaignId', ensureAuthenticated, updateCampaignHandler)
  app.patch('/campaigns/:campaignId/managers', ensureAuthenticated, updateCampaignManagersHandler)
  app.post('/campaigns/:campaignId/open', ensureAuthenticated, openCampaignHandler)
  app.post('/campaigns/:campaignId/close', ensureAuthenticated, closeCampaignHandler)
  app.get('/campaigns/:campaignId/context', ensureAuthenticated, getCampaignContextHandler)
  app.get('/campaigns/:campaignId/responses', ensureAuthenticated, listCampaignResponsesHandler)
  app.get('/campaigns/:campaignId/responses/summary', ensureAuthenticated, getCampaignResponseSummaryHandler)
  app.get('/campaigns/:campaignId/responses/overview', ensureAuthenticated, listCampaignResponseOverviewHandler)
  app.get('/campaigns/:campaignId/responses/results', ensureAuthenticated, getCampaignResponseResultsHandler)
  app.get('/campaigns/:campaignId/responses/:kind/history', ensureAuthenticated, getCampaignResponseHistoryHandler)
  app.patch('/campaigns/:campaignId/responses/:kind', ensureAuthenticated, saveCampaignResponseHandler)
  app.post('/campaigns/:campaignId/responses/:kind/submit', ensureAuthenticated, submitCampaignResponseHandler)
  app.post('/campaigns/:campaignId/responses/:kind/reopen', ensureAuthenticated, reopenCampaignResponseHandler)
  app.post('/campaigns/:campaignId/targets/:targetId/meters', ensureAuthenticated, manageCampaignMeterHandler)
  app.patch('/campaigns/:campaignId/targets/:targetId/meters/:associationId', ensureAuthenticated, manageCampaignMeterHandler)
  app.get('/campaigns/:campaignId/exports', ensureAuthenticated, listCampaignExportsHandler)
  app.post('/campaigns/:campaignId/exports', ensureAuthenticated, createCampaignExportHandler)
  app.get('/campaigns/:campaignId/exports/:exportId', ensureAuthenticated, getCampaignExportHandler)
  app.get('/campaigns/:campaignId/notifications', ensureAuthenticated, listCampaignNotificationsHandler)
  app.post('/campaigns/:campaignId/notifications/remind', ensureAuthenticated, remindCampaignHandler)
  app.get(
