...
async function createRoutes() {
  ...
  app.post('/users/me/email-aliases', ensureAuthenticated, createMyEmailAliasHandler)
  app.delete('/users/me/email-aliases/:emailAliasId', ensureAuthenticated, deleteMyEmailAliasHandler)
  ...
  app.get('/declarations/:declarationId/available-points-prelevements', ensureRole('DECLARANT', 'INSTRUCTOR'), getAvailablePointsPrelevementsForDeclarationHandler)
  app.post('/declarations/:declarationId/chunks/:chunkId/reconcile', ensureRole('DECLARANT', 'INSTRUCTOR'), reconcileDeclarationChunkHandler)
  ...
  /* Dashboard */
  app.get('/dashboard/territory', ensureRole('INSTRUCTOR', 'ADMIN', 'DECLARANT'), getDashboardTerritoryHandler)
  app.get('/dashboard/water-resources/piezometry', ensureRole('INSTRUCTOR', 'ADMIN', 'DECLARANT'), getDashboardPiezometryHandler)
  app.get('/dashboard/water-resources/flows', ensureRole('INSTRUCTOR', 'ADMIN', 'DECLARANT'), getDashboardRiverFlowsHandler)
  ...
  /* Exports */
  app.get('/exports/options', ensureRole('INSTRUCTOR'), getDataExportOptionsHandler)
  app.route('/exports')
    .get(ensureRole('INSTRUCTOR'), listDataExportsHandler)
    .post(ensureRole('INSTRUCTOR'), createDataExportHandler)
  app.route('/exports/:exportId')
    .get(ensureRole('INSTRUCTOR'), getDataExportHandler)
    .delete(ensureRole('INSTRUCTOR'), deleteDataExportHandler)
  app.get('/exports/:exportId/download', ensureRole('INSTRUCTOR'), getDataExportDownloadHandler)
  ...
  app.route('/points-prelevement')
    .get(ensureRole('INSTRUCTOR', 'DECLARANT', 'ADMIN'), listPointsPrelevement)
    .post(ensureRole('INSTRUCTOR', 'ADMIN'), createPointPrelevementHandler)

  app.route('/points-prelevement/options')
    .get(ensureRole('INSTRUCTOR', 'DECLARANT', 'ADMIN'), listPointsPrelevementOptions)

  app.route('/points-prelevement/map')
    .get(ensureRole('INSTRUCTOR', 'DECLARANT', 'ADMIN'), listPointMapSummaries)

  app.route('/points-prelevement/:pointId')
    .get(authorizePointPrelevement('read'), getPointPrelevementDetail)
    .put(authorizePointPrelevement('write'), updatePointPrelevementHandler)
    .delete(authorizePointPrelevement('write'), deletePointPrelevementHandler)
  ...
  app.route('/zones/:zoneId')
    .get(ensureRole('INSTRUCTOR'), getZoneHandler)

  app.route('/zones/:zoneId/geometry')
    .get(ensureRole('INSTRUCTOR'), getZoneGeometryHandler)

  app.route('/zones/:zoneId/declarants')
    .get(ensureRole('INSTRUCTOR'), listZoneDeclarantsHandler)

  app.route('/zones/:zoneId/collecteurs')
    .get(ensureRole('INSTRUCTOR'), listZoneCollecteursHandler)
  ...
  app.route('/zones/:zoneId/suivi-declarations')
    .get(ensureRole('INSTRUCTOR'), getZoneDeclarationMonthlyStatusHandler)

  app.route('/zones/:zoneId/declaration-settings')
    .get(ensureRole('INSTRUCTOR'), getZoneDeclarationSettingsHandler)
    .put(ensureRole('INSTRUCTOR'), updateZoneDeclarationSettingsHandler)

  app.route('/zones/:zoneId/declaration-period-overrides')
    .post(ensureRole('INSTRUCTOR'), createZoneDeclarationOverrideHandler)

  app.route('/zones/:zoneId/declaration-period-overrides/:overrideId')
    .put(ensureRole('INSTRUCTOR'), updateZoneDeclarationOverrideHandler)
    .delete(ensureRole('INSTRUCTOR'), deleteZoneDeclarationOverrideHandler)

  app.route('/zones/:zoneId/monitoring-stations')
    .get(ensureRole('INSTRUCTOR'), listZoneMonitoringStationsHandler)
    .post(ensureRole('INSTRUCTOR'), createZoneMonitoringStationHandler)

  app.route('/zones/:zoneId/monitoring-stations/:associationId')
    .patch(ensureRole('INSTRUCTOR'), updateZoneMonitoringStationHandler)
    .delete(ensureRole('INSTRUCTOR'), deleteZoneMonitoringStationHandler)

  app.route('/zones/:zoneId/points-prelevement')
    .get(ensureRole('INSTRUCTOR'), listZonePointsPrelevementHandler)
    .post(ensureRole('INSTRUCTOR'), createZonePointPrelevementHandler)

  app.route('/zones/:zoneId/points-prelevement/options')
    .get(ensureRole('INSTRUCTOR'), listZonePointOptionsHandler)

  app.route('/zones/:zoneId/points-prelevement/:pointId')
    .get(ensureRole('INSTRUCTOR'), getZonePointPrelevementHandler)
    .put(ensureRole('INSTRUCTOR'), updateZonePointPrelevementHandler)
    .delete(ensureRole('INSTRUCTOR'), deleteZonePointPrelevementHandler)

  app.route('/zones/:zoneId/exploitations')
    .get(ensureRole('INSTRUCTOR'), listZoneExploitationsHandler)
    .post(ensureRole('INSTRUCTOR'), createZoneExploitationHandler)

  app.route('/zones/:zoneId/exploitations/declarants-options')
    .get(ensureRole('INSTRUCTOR'), listZoneDeclarantOptionsHandler)

  app.route('/zones/:zoneId/exploitations/:exploitationId')
    .get(ensureRole('INSTRUCTOR'), getZoneExploitationHandler)
    .put(ensureRole('INSTRUCTOR'), updateZoneExploitationHandler)
    .delete(ensureRole('INSTRUCTOR'), deleteZoneExploitationHandler)

  app.route('/zones/:zoneId/instructeurs')
    .get(ensureRole('INSTRUCTOR'), listZoneInstructorsHandler)
    .post(ensureRole('INSTRUCTOR'), addZoneInstructorHandler)

  app.route('/zones/:zoneId/instructeurs/options')
    .get(ensureRole('INSTRUCTOR'), listZoneInstructorOptionsHandler)

  app.route('/zones/:zoneId/instructeurs/:instructorUserId')
    .get(ensureRole('INSTRUCTOR'), getZoneInstructorHandler)
    .delete(ensureRole('INSTRUCTOR'), removeZoneInstructorHandler)

  /* Exploitations */

  app.route('/exploitations')
    .post(ensureRole('INSTRUCTOR', 'ADMIN'), createExploitationHandler)

  app.route('/exploitations/:exploitationId')
    .get(authorizeExploitation('read'), getExploitationDetail)
    .put(authorizeExploitation('write'), updateExploitationHandler)
    .delete(authorizeExploitation('write'), deleteExploitationHandler)

  app.get('/exploitations/:exploitationId/documents', authorizeExploitation('read'), getExploitationDocuments)

  /* Règles */

  app.route('/regles/:regleId')
    .get(authorizeRegle('read'), getRegleDetail)
    .put(authorizeRegle('write'), updateRegleHandler)
    .delete(authorizeRegle('write'), deleteRegleHandler)

  /* Documents */

  app.route('/documents/:documentId')
    .get(authorizeDocument('read'), getDocumentDetail)
    .put(authorizeDocument('write'), updateDocumentHandler)
    .delete(authorizeDocument('write'), deleteDocumentHandler)

  /* Déclarants */

  app.route('/declarants')
    .get(ensureRole('INSTRUCTOR', 'ADMIN'), listDeclarants)
  ...
  app.route('/declarants/:declarantId')
    ...
    .put(authorizeDeclarant('write'), updatePreleveurHandler)
    .delete(authorizeDeclarant('write'), deletePreleveurHandler)

  app.route('/declarants/:declarantId/declaration-types')
    .get(ensureRole('INSTRUCTOR', 'ADMIN'), authorizeDeclarant('read'), listDeclarantDeclarationTypesHandler)
    .post(ensureRole('INSTRUCTOR', 'ADMIN'), authorizeDeclarant('write'), addDeclarantDeclarationTypeHandler)

  app.route('/declarants/:declarantId/declaration-types/:linkId')
    .put(ensureRole('INSTRUCTOR', 'ADMIN'), authorizeDeclarant('write'), updateDeclarantDeclarationTypeHandler)
    .delete(ensureRole('INSTRUCTOR', 'ADMIN'), authorizeDeclarant('write'), removeDeclarantDeclarationTypeHandler)
  ...
  app.route('/declarants/:declarantId/email-aliases')
    .get(authorizeDeclarant('read'), listDeclarantEmailAliasesHandler)
    .post(authorizeDeclarant('write'), createDeclarantEmailAliasHandler)

  app.delete(
    '/declarants/:declarantId/email-aliases/:emailAliasId',
    authorizeDeclarant('write'),
    deleteDeclarantEmailAliasHandler
  )

  app.get('/preleveurs/:declarantId/points-prelevement', authorizeDeclarant('read'), getPreleveurPointsPrelevement)

  app.get('/preleveurs/:declarantId/exploitations', authorizeDeclarant('read'), getPreleveurExploitationsHandler)
  app.get('/preleveurs/:declarantId/exploitations-via-points', authorizeDeclarant('read'), getPreleveurExploitationsViaPointsHandler)

  /* Préleveurs - Règles */

  app.route('/preleveurs/:declarantId/regles')
    .get(authorizeDeclarant('read'), getPreleveurReglesHandler)
    .post(authorizeDeclarant('write'), createPreleveurRegle)

  /* Préleveurs - Documents */

  app.route('/preleveurs/:declarantId/documents')
    .get(authorizeDeclarant('read'), getPreleveurDocumentsHandler)
    .post(authorizeDeclarant('write'), upload.single('document'), createPreleveurDocument)
