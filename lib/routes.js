...
import {reconstructVolumesFromIndexForServiceAccountHandler} from './handlers/service-account-reconstruct-volumes.js'
...
async function createRoutes() {
  ...
  app.post(
    '/service-accounts/me/reconstruct-volumes-from-index',
    ensureServiceAccountAuthenticated,
    reconstructVolumesFromIndexForServiceAccountHandler
  )
