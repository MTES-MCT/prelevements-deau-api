...
export function createRoutes({
  ...
  app.route('/campaigns/:campaignId/responses/:responseId').get(getCollectionResponseHandler)
    .put(ensureNotImpersonating, saveCollectionResponseDraftHandler)
  app.post('/campaigns/:campaignId/responses/:responseId/submit', ensureNotImpersonating, submitCollectionResponseHandler)
