...
import {
  ...
  authorize,
  ensureAuthenticated,
  ensureRole, authorizePointPrelevement, authorizeExploitation, authorizeDeclarant, authorizeSource, authorizeChunk
...
import {
  ...
  getPointExploitations, listPointsPrelevementOptions
...
import {
  ...
  getDeclarationDetailHandler, getAvailablePointsPrelevementsForDeclarationHandler
...
async function createRoutes() {
  ...
  app.route('/preleveurs/:declarantId')
    .get(authorizeDeclarant('read'), getPreleveurDetail)
