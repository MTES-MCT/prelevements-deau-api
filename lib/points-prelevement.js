...
// Getters
export function getBeneficiairesFromPoint(idPoint) {
...
export async function getPointsPrelevement() {
  for (const point of pointsPrelevement) {
    point.beneficiaires = getBeneficiairesFromPoint(point.id_point)
...
export async function getPointPrelevement(idPoint) {
  ...
  point.beneficiaires = getBeneficiairesFromPoint(idPoint)
