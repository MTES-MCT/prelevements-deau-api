...
const ENTITY_FIELDS = Object.freeze({
  ...
  EXPLOITATION: [
    ...
    'usageId', 'pointPrelevementNameAliases', 'sourceId',
    'mostRecentAvailableDate', 'collecteurUserIds', 'connectors'
  ],
  DECLARANT: [
    'email', 'firstName', 'lastName', 'declarantType', 'declarantRole',
  ...
  DOCUMENT: [
    'declarantUserId', 'declarantPointPrelevementId', 'title', 'reference',
...
async function loadMutationEntity(client, entityType, entityId, request) {
  ...
  switch (entityType) {
    ...
    case 'DOCUMENT': {
      return client.resourceDocument.findUnique({where: {id: entityId}})
    }
