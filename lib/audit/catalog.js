...
export const AUDIT_ACTIONS = Object.freeze([
  action('POST', '/campaigns', 'CAMPAIGN.CREATED', 'CAMPAIGN', 'Création d’une campagne', {target: {type: 'CAMPAIGN'}}),
  action('GET', '/campaigns/:campaignId/responses/:kind/history', 'CAMPAIGN.HISTORY_VIEWED', 'CAMPAIGN', 'Consultation des récépissés de campagne', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('PATCH', '/campaigns/:campaignId', 'CAMPAIGN.UPDATED', 'CAMPAIGN', 'Modification d’une campagne', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('PATCH', '/campaigns/:campaignId/managers', 'CAMPAIGN.SHARING_UPDATED', 'CAMPAIGN', 'Modification du partage du suivi', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('POST', '/campaigns/:campaignId/open', 'CAMPAIGN.OPENED', 'CAMPAIGN', 'Ouverture d’une campagne', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('POST', '/campaigns/:campaignId/close', 'CAMPAIGN.CLOSED', 'CAMPAIGN', 'Clôture d’une campagne', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('PATCH', '/campaigns/:campaignId/responses/:kind', 'CAMPAIGN.DRAFT_SAVED', 'CAMPAIGN', 'Enregistrement d’un brouillon de campagne', {subject: {body: 'preleveurUserId'}, target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('POST', '/campaigns/:campaignId/responses/:kind/submit', 'CAMPAIGN.SUBMITTED', 'CAMPAIGN', 'Transmission d’une réponse de campagne', {subject: {body: 'preleveurUserId'}, target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('POST', '/campaigns/:campaignId/responses/:kind/reopen', 'CAMPAIGN.RESPONSE_REOPENED', 'CAMPAIGN', 'Réouverture d’une réponse de campagne', {subject: {body: 'preleveurUserId'}, target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('POST', '/campaigns/:campaignId/targets/:targetId/meters', 'CAMPAIGN.METER_CREATED', 'CAMPAIGN', 'Affectation d’un compteur', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('PATCH', '/campaigns/:campaignId/targets/:targetId/meters/:associationId', 'CAMPAIGN.METER_UPDATED', 'CAMPAIGN', 'Modification d’une affectation de compteur', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('POST', '/campaigns/:campaignId/exports', 'CAMPAIGN.EXPORT_CREATED', 'EXPORT', 'Demande d’export de campagne', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('GET', '/campaigns/:campaignId/exports/:exportId', 'CAMPAIGN.EXPORT_ACCESSED', 'EXPORT', 'Consultation d’un export de campagne', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
  action('POST', '/campaigns/:campaignId/notifications/remind', 'CAMPAIGN.REMINDER_REQUESTED', 'NOTIFICATION', 'Demande de relance de campagne', {target: {type: 'CAMPAIGN', param: 'campaignId'}}),
