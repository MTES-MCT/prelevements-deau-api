...
export const ZONE_PERMISSION_GROUPS = Object.freeze([
  {
    ...
    permissions: [
      permission({code: 'campaign.read', label: 'Consulter les campagnes', description: 'Consulter les campagnes et les réponses des points de la zone.', requires: ['zone.detail.read']}),
      permission({code: 'campaign.manage', label: 'Gérer les campagnes', description: 'Configurer les campagnes, les ouvrir, les clore et demander une correction.', requires: ['campaign.read']}),
      permission({code: 'campaign.export', label: 'Exporter les campagnes', description: 'Exporter les réponses des points autorisés de la zone.', requires: ['campaign.read']})
    ]
  },
  {
    code: 'zone',
