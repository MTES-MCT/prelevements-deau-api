...
const DOCUMENT_FIELDS = {
  ...
  declarantPointPrelevementId: resourceIdSchema,
  declarantPointPrelevementIds: Joi.array()
    .single()
    .items(resourceIdSchema)
    .unique()
}
...
const documentSchemaCreation = Joi.object().keys({
  ...
  declarantPointPrelevementIds: DOCUMENT_FIELDS.declarantPointPrelevementIds
}).oxor('declarantPointPrelevementId', 'declarantPointPrelevementIds')
