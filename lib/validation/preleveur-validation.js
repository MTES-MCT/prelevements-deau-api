...
const preleveurSchema = Joi.object().keys({
  ...
  declarantRole: PRELEVEUR_FIELDS.declarantRole.default('PRELEVEUR'),
  quickDeclarationEnabled: PRELEVEUR_FIELDS.quickDeclarationEnabled.default(true),
  declarationNotificationsEnabled: PRELEVEUR_FIELDS.declarationNotificationsEnabled.default(true),
