...
const preleveurSchema = Joi.object().keys({
  ...
  nom: addStringMessages(PRELEVEUR_FIELDS.nom.required(), 'Nom'),
  prenom: addStringMessages(PRELEVEUR_FIELDS.prenom.required(), 'Prenom'),
  email: addStringMessages(PRELEVEUR_FIELDS.email.required(), 'Email'),
