...
import {POINT_FLOW_TYPE_VALUES, POINT_FLOW_TYPES} from '../constants/point-flow-types.js'
...
function normalizeFlowFields(value) {
  if (value.flowType === POINT_FLOW_TYPES.REJET) {
    value.withdrawalType = null
  }
...
function validateCreation(point) {
  return normalizeFlowFields(validatePayload(point, pointSchemaCreation))
}

function validateChanges(changes) {
  return normalizeFlowFields(validatePayload(changes, pointSchemaEdition))
}
